...
> **Notion反映**: §2-6 ゴール、§2 目次（§1-2〜1-8 深掘りはローカルのみ）
...
| セキュリティ | foro | セキュリティ担保、リスクの早期発見・対処 |
...
| 項目 | 内容 |
|------|------|
| チーム | **FDEチーム** — 顧客現場で課題を見つけ、実装まで届ける |
| メンバー | 黒川（メイン）、FDE(採用) |
...
| リスク | 打ち手 |
|--------|--------|
| 顧客視点は強いが技術面が不安 | AI駆動開発環境の整備 |
| AI環境未整備 | テックリード(採用)・馬場・山田 |
| 黒川の兼務（FDE / DataOps / AI DPC） | メインと兼務の整理 |
...
- [ ] テックリード採用の要件（foroの技術面・セキュリティをどこまでカバーするか）
